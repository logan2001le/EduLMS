...
const userController = {
    ...
    createUser: async (req, res) => {
        try {
            const { email, password, phone, username, role, status } = req.body;
            ...
            // Check if phone already exists in your database
            ...
            // Call CometChat API to create user
            const cometChatAppId = '254959907a3e959b';
